...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/css-library.css')); ?>">
    ...
    <script src="<?php echo e(asset('assets/js/bKash-checkout.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/bKash-checkout-sandbox.js')); ?>"></script>
        ...
        <div class="container">
                    <nav class="main-nav">
                        ...
                        <a href="<?php echo e(url('home')); ?>" class="logo">
                            <img width="100px" src="<?php echo e(asset('assets/images/logo.png')); ?>">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            ...
                            <span class='badge badge-warning' id='lblCartCount'> <?php echo e($cart_amount); ?> </span>
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="logo">
                        <a href="<?php echo e(url('home')); ?>"><img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-xs-12">
...
</html><?php /**PATH /var/www/html/Restaurant_Ecommerce_System_Laravel-master/resources/views/layout.blade.php ENDPATH**/ ?>
                ...
                <div class="col-lg-8">
                    <div class="main-banner header-text">
                        ...
                        <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <div class="item">
                            <div class="img-fill">
                                <img src="<?php echo e(asset('assets/images/'.$banner->image)); ?>" alt="">
                            </div>
                          </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <?php $__currentLoopData = $about_us; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a_us): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h6>About Us</h6>
                            <h2><?php echo e($a_us->title); ?></h2>
                        </div>
                        <p><?php echo e($a_us->description); ?></p>
                        <div class="row">
                            <div class="col-4">
                                <img src="<?php echo e(asset('assets/images/'.$a_us->image1)); ?>" alt="">
                            </div>
                            <div class="col-4">
                                <img src="<?php echo e(asset('assets/images/'.$a_us->image2)); ?>" alt="">
                            </div>
                            <div class="col-4">
                                <img src="<?php echo e(asset('assets/images/'.$a_us->image3)); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-content">
                        <div class="thumb">
                            <a rel="nofollow" href="<?php echo e($a_us->youtube_link); ?>" target="_blank"> <i class="fa fa-play"></i></a>
                            <img src="<?php echo e(asset('assets/images/'.$a_us->vd_image)); ?>" alt="">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="left-list">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="tab-item">
                                                            <img src="<?php echo e(asset('assets/images/'.$item->image)); ?>" alt="">
...
<section class="section"  id="menu">
        ...
        <div class="menu-item-carousel">
            <div class="col-lg-12">
                <div class="owl-menu-item owl-carousel" >
                    ...
                    <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php
                        $img=$product->image;
                    ?>
                        <div class='card' style="background-image: url(<?php echo e(asset('assets/images/'.$img)); ?>)"> 

                            <div class="price"><h6>৳<?php echo e($product->price); ?></h6>
      ...
      <br>
                                   <a href="/rate/<?php echo e($product->id); ?>" style="color:blue;">Rate this</a>
                                  <p>Quantity: </p>
                                <?php if($product->available=="Stock"): ?>
                                  <form method="post" action="<?php echo e(route('cart.store',$product->id)); ?>">
                                     <?php echo csrf_field(); ?>
                    ...
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <ul class="social-icons">
                                <li><a href="<?php echo e($chef->facebook_link); ?>" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="<?php echo e($chef->twitter_link); ?>" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="<?php echo e($chef->instragram_link); ?>" target="_blank"><i class="fa fa-instagram"></i></a></li>
                            </ul>
                            <img src="<?php echo e(asset('assets/images/'.$chef->image)); ?>" alt="Chef #1">
                        </div>
                        <div class="down-content">
                            <h4><?php echo e($chef->name); ?></h4>
                            <span><?php echo e($chef->job_title); ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout', ['title'=> 'Home'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Restaurant_Ecommerce_System_Laravel-master/resources/views/home.blade.php ENDPATH**/ ?>
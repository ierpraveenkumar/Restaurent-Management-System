  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <?php endif; ?>
          <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="<?php echo e(asset('admin/assets//images/logo-mini.svg')); ?>" alt="logo" /></a>
        </div>
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="<?php echo e(asset('assets/images/admin/'.Auth::user()->profile_photo_path)); ?>" alt="">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<?php echo e(asset('admin/assets//images/logo-mini.svg')); ?>" alt="logo" /></a>
          </div>
...
<?php /**PATH /var/www/html/Restaurant_Ecommerce_System_Laravel-master/resources/views/admin/adminlayout.blade.php ENDPATH**/ ?>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <button class="btn btn-primary btn-lg btn-block" id="sslczPayBtn"
                        ...
                        endpoint="<?php echo e(url('/pay-via-ajax')); ?>" onclick="myFunction()"> Pay Now
                </button>
            </form>
        </div>
    </div>
...
<?php /**PATH /var/www/html/Restaurant_Ecommerce_System_Laravel-master/resources/views/exampleEasycheckout.blade.php ENDPATH**/ ?>
...
Route::get('/excel-editor', [HomeController::class, 'integrateExcelEditor'])->name('excel.editor');
Route::post('/excel-editor/save', [HomeController::class, 'saveExcelChanges'])->name('excel.save');
